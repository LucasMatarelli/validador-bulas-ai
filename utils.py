...
with c1:
    ...
    # CORREÇÃO AQUI: Label obrigatório adicionado
    f1 = st.file_uploader("Upload Referência", type=["pdf", "docx"], key="f1", label_visibility="collapsed")
with c2:
    st.markdown("##### 📄 Arquivo BELFAR")
    # CORREÇÃO AQUI: Label obrigatório adicionado
    f2 = st.file_uploader("Upload Belfar", type=["pdf", "docx"], key="f2", label_visibility="collapsed")
