...
def get_gemini_model():
    ...
    # Prioridade total para o 2.5 Flash
...
with st.sidebar:
    ...
    if model: 
        ...
        st.error("❌ Erro de Conexão nos Secrets")
            ...
            with st.spinner(f"🤖 Auditando com {model_name} (Seguro)..."):
                try:
                    ...
                    if hasattr(response.candidates[0], 'finish_reason') and response.candidates[0].finish_reason == 4:
                        ...
                        st.warning("O modelo 2.5 Flash identificou o conteúdo como protegido e bloqueou. Tente enviar apenas as páginas específicas ou usar o modelo 1.5 Pro (que é mais permissivo).")
                    else:
