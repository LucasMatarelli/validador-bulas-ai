...
def paint_rect(doc, page_idx, rect, color, opacity=0.8): # MUDANÇA: Opacidade 0.8
    """Pinta o retângulo no PDF com opacidade sólida."""
...
def process_and_mark(doc_ref, doc_bel, words_ref, words_bel):
    ...
    yellow = (1, 1, 0) # MUDANÇA: Amarelo puro (1, 1, 0)
