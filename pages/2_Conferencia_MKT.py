...
def gerar_diff_html(texto_ref, texto_novo):
    ...
    # Comparação ignorando tags HTML
    ...
    if f1 and f2:
        ...
        with st.spinner("Lendo arquivos e conectando à IA..."):
            ...
            1. **CABEÇALHO DA BULA**: Extrair TODO o conteúdo desde o início do documento ATÉ (mas NÃO incluindo) o título "APRESENTAÇÕES". 
               - Inclui: nome completo do produto com todas as dosagens (ex: 5 mg, 10 mg e 20 mg), código de barras, Lei nº, texto introdutório completo
               - Inclui frases como "I – IDENTIFICAÇÃO DO PRODUTO", "II – INFORMAÇÕES QUANTO ÀS APRESENTAÇÕES E COMPOSIÇÃO", "III – INFORMAÇÕES AO PACIENTE"
               - IMPORTANTE: Remover APENAS os algarismos romanos (I, II, III, IV, V) e o hífen/traço que vem logo após eles, mantendo TODO o resto do texto.
               - Exemplo: "I – IDENTIFICAÇÃO DO PRODUTO" → "IDENTIFICAÇÃO DO PRODUTO"
               - PARAR antes de encontrar "APRESENTAÇÕES" ou qualquer variação.
               - Extrair de forma IDÊNTICA para ambos os arquivos
            ...
            try:
                ...
                for item in dados_secoes:
                    ...
                    if "CABEÇALHO" in titulo.upper():
                        # Remove I –, II –, III –, IV –, V – do conteúdo mantendo o texto
